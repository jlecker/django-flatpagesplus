...
class FlatpageTemplateTagTests(TestCase):
    ...
    urls = 'flatpagesplus.tests.urls'

    def setUp(self):
        self.old_MIDDLEWARE_CLASSES = settings.MIDDLEWARE_CLASSES
        flatpage_middleware_class = 'flatpagesplus.middleware.FlatpageFallbackMiddleware'
    ...
    def test_get_flatpages_tag_for_user(self):
        ...
        self.assertEquals(out, "A Flatpage,A Nested Flatpage,Sekrit Nested Flatpage,Sekrit Flatpage,Flatpage With Extra Content,Flatpage With Extra Content and Linked Subpages,Flatpage with Linked Subpages,")
    ...
    def test_parsing_errors(self):
        ...
        self.assertRaises(TemplateSyntaxError, render,
                          "{% load flatpagesplus_tags %}{% get_flatpages %}")
        self.assertRaises(TemplateSyntaxError, render,
                          "{% load flatpagesplus_tags %}{% get_flatpages as %}")
        self.assertRaises(TemplateSyntaxError, render,
                          "{% load flatpagesplus_tags %}{% get_flatpages cheesecake flatpages %}")
        self.assertRaises(TemplateSyntaxError, render,
                          "{% load flatpagesplus_tags %}{% get_flatpages as flatpages asdf%}")
        self.assertRaises(TemplateSyntaxError, render,
                          "{% load flatpagesplus_tags %}{% get_flatpages cheesecake user as flatpages %}")
        self.assertRaises(TemplateSyntaxError, render,
                          "{% load flatpagesplus_tags %}{% get_flatpages for user as flatpages asdf%}")
        self.assertRaises(TemplateSyntaxError, render,
                          "{% load flatpagesplus_tags %}{% get_flatpages prefix for user as flatpages asdf%}")
